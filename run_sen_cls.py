...
def main():
    ...
    assert num_labels == len(categories2ids), f"Number of labels ({num_labels}) in training set does not match number of categories ({len(categories2ids)})"
    ...
    # assert data_args.task_name is None
    # if data_args.task_name is not None:
